...
public class NodeUser {
        ...
        public void addNode(Node newNode) {
            ...
            System.out.println("NODE_USER | " + nodeEmail + " Nodes Size : " + nodesMap.size());
        }
        ...
        if (nodeUserCompletedSubtasksMap.get(subtaskID) == null) {
            ...
            System.out.println("NODE_USER | " + subtaskCost.subtaskID + " added to " + nodeEmail + "'s list of Completed Subtasks." );
        ...
        public class Node {
            ...
            public void addSubtasksToNode(ResultReceiver.SubtaskCosts subtaskCost) {
                ...
                if (nodeCompletedSubtasksMap.isEmpty()) {
                    ...
                    System.out.println("NODE_USER | " + subtaskCost.subtaskID + " added to " + nodeEmail + "'s [" + ipAddress + "] list of Completed Subtasks." );
                ...
                System.out.println("NODE_USER | Completed Subtasks for " + nodeEmail + " [" + ipAddress + "] : " + nodeCompletedSubtasksMap.size());
            }
